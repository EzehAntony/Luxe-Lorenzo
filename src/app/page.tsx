  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-hot-pink-gradient select-none">
      {showSplash ? (
        ...
        <>
          <CartIcon />
          <section className="w-full max-w-2xl mx-auto flex flex-col items-center gap-10 p-4">
            ...
            <div className="flex flex-col md:flex-row gap-8 w-full justify-center">
              ...
              <Link href="/buy-wig" className="group flex-1 bg-white/10 border border-white/30 rounded-2xl p-8 flex flex-col items-center gap-4 transition-all duration-200 cursor-pointer min-w-[220px] text-center hover:scale-[1.02] hover:bg-white/15 hover:shadow-lg">
                <div className="relative w-40 h-40 overflow-hidden rounded-lg transition-transform duration-200 group-hover:scale-105">
                  <Image
                    src="/wig1.png"
                    alt="Buy a Wig"
                    fill
